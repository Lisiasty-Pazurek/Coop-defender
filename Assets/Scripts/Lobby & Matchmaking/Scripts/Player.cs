...
//            SceneManager.LoadScene(levelController.gameMode.mapName);
        }
...
//        uIGameplay.ChangeUIState(3); // not used yet but it should work, it is overriden by next function too get back to lobby //       uIScore.ResetValues();
